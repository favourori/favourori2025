...
import { AppDrawer, Link } from "@/components";
import { contact, GuestHeaderMenu } from "@/configs";
...
export function GuestFooter() {
    ...
    return (
        <>
            ...
            <AppDrawer uuid="mobileMenu" placement="start" className="bg-blur">
                <div className="list-group list-group-flush text-center fs-18 mb-auto h-100">
